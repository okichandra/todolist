...
function Register() {
    ...
    return (
        <SignLayout signData="register">
            <Toggle info="right-1" />
            <form action="">
                <input type="text" placeholder='Enter Your Username' className='pl-4 text-sm font-light text-second-text-color  w-full p-2 rounded-lg bg-main-color mt-4 border border-second-color' />
                ...
                <div className="pw mt-4 relative">
                    <input type={type} placeholder='Enter Your Password' className='pl-4 font-light text-sm text-second-text-color  w-full p-2 rounded-lg bg-main-color border border-second-color' />
